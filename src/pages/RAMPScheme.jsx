...
export default function RAMPScheme() {
  const { t, i18n } = useTranslation();

  const schemeImage = i18n.language === "hi" ? HiRAMP : RAMP;
  ...
  return (
    <div className="px-4 sm:px-8 lg:px-16 py-10 max-w-6xl mx-auto text-slate-800">
      ...
      <p className="mb-8 text-sm sm:text-base">
        <strong>{t("ramp.eligibility_label")}</strong>{" "}
        {t("ramp.eligibility_detail")}
      </p>
